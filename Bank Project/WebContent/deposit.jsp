...
<body>
	...
	<div style= "margin-top: 5%">
		...
		<form class="form-inline" action="depositServlet" >
			<input type="text" class="form-control mr-sm-2" name="amount" placeholder="Amount">
			<button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="checking" value= "true">Deposit</button>
		</form>
		<h6>Saving balance: <fmt:formatNumber value = "${sbalance}" type = "currency"/></h6>
		<form class="form-inline" action="depositServlet" >
			<input type="text" class="form-control mr-sm-2" name="amount" placeholder="Amount">
			<button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="checking" value= "false">Deposit</button>
		</form>
	</div>
