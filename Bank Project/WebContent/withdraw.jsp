...
<body>
	...
	<div style= "margin-top: 5%">
		...
		<form class="form-inline" action="WithdrawServlet" >
			...
			<button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="checking" value= "true">Withdraw</button>
		</form>
		<h6>Saving balance: <fmt:formatNumber value = "${sbalance}" type = "currency"/></h6>
		<form class="form-inline" action="WithdrawServlet" >
			<input type="text" class="form-control mr-sm-2" name="amount" placeholder="Amount">
			<button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="checking" value= "false">Withdraw</button>
		</form>
	</div>
